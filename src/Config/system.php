    ...
    [
        ...
        'fields' => [
            [
                ...
                'name'          => 'api_key',
                'title'         => 'iyzico::app.iyzico.system.api_key',
                'info'          => 'iyzico::app.iyzico.system.api_key_info',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'secret_key',
                'title'         => 'iyzico::app.iyzico.system.secret_key',
                'info'          => 'iyzico::app.iyzico.system.secret_key_info',
                'type'          => 'password',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
